...
public class ShapedOreModule implements IRecipesModule{
    ...
    public class RecipeData implements IRecipeData
    {
        ...
        public String generateDescription() {
            ...
            int width = ObfuscationReflectionHelper.getPrivateValue(ShapedOreRecipe.class, sr, 4);
            int height = ObfuscationReflectionHelper.getPrivateValue(ShapedOreRecipe.class, sr, 5);
            Object[] items = sr.getInput();
